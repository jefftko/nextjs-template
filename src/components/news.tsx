        ...
        <div className="py-12 md:py-20">
          ...
          <div className="mx-auto max-w-sm md:max-w-none">
            <div className="grid items-start gap-12 md:grid-cols-3 md:gap-x-6 md:gap-y-8">
                ...
                <header>
                  <a href="#0" className="mb-6 block">
                    <figure className="pb-9/16 translate-z-0 relative h-0 overflow-hidden rounded">
                      <Image
                        className="absolute inset-0 h-full w-full scale-105 object-cover transition duration-700 ease-out hover:-translate-y-1"
                        src={NewsImage01}
                        width={352}
                        height={198}
                        alt="News 01"
              ...
              {/* 2nd article */}
              <article className="flex h-full flex-col" data-aos="zoom-y-out" data-aos-delay="150">
                <header>
                  <a href="#0" className="mb-6 block">
                    <figure className="pb-9/16 translate-z-0 relative h-0 overflow-hidden rounded">
                      <Image
                        className="translate-z-0 absolute inset-0 h-full w-full scale-105 object-cover transition duration-700 ease-out hover:-translate-y-1"
                        src={NewsImage02}
                        width={352}
                        height={198}
                        alt="News 02"
              ...
              {/* 3rd article */}
              <article className="flex h-full flex-col" data-aos="zoom-y-out" data-aos-delay="300">
                <header>
                  <a href="#0" className="mb-6 block">
                    <figure className="pb-9/16 translate-z-0 relative h-0 overflow-hidden rounded">
                      <Image
