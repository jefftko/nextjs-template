            ...
            <table className="w-full table-auto border-b border-gray-200">
              ...
              <thead>
                <tr className="border-t border-gray-200 text-base sm:text-lg">
                  <th className="text-bold min-w-48 py-4 pr-2 text-left">Breakdown of features</th>
                  ...
                  <th className="text-bold py-4 pl-2 text-center">Enterprise</th>
                </tr>
              </thead>
              {/* Table body */}
              <tbody>
                ...
                <tr className="border-t border-gray-200">
                  ...
                  <td className="px-2 py-4 text-center text-sm font-medium">3</td>
                  <td className="px-2 py-4 text-center text-sm font-medium">Unlimited</td>
                  <td className="px-2 py-4 text-center text-sm font-medium">Unlimited</td>
                  <td className="py-4 pl-2 text-center text-sm font-medium">Unlimited</td>
                </tr>
                {/* Row */}
                <tr className="border-t border-gray-200">
                  <td className="py-4 pr-2 text-sm sm:text-base">
                  ...
                  <td className="px-2 py-4 text-center text-sm font-medium">3</td>
                  <td className="px-2 py-4 text-center text-sm font-medium">20</td>
                  <td className="px-2 py-4 text-center text-sm font-medium">50</td>
                  <td className="py-4 pl-2 text-center text-sm font-medium">Unlimited</td>
                </tr>
                {/* Row */}
                <tr className="border-t border-gray-200">
