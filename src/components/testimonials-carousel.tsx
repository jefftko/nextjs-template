...
export default function TestimonialsCarousel() {
  ...
  useEffect(() => {
    ...
    const interval = setInterval(() => {
      setActive(active + 1 === items.length ? 0 : (item) => item + 1)
    }, autorotateTiming)
  ...
  return (
    <section className="relative">
      ...
      <div
        className="pointer-events-none absolute bottom-0 left-1/2 mb-20 -translate-x-1/2"
        aria-hidden="true"
      >
        <svg
          width="1360"
          ...
          <div className="mx-auto max-w-3xl">
            ...
            <div className="relative mt-20" data-aos="zoom-y-out">
                  ...
                  {items.map((item, index) => (
                    ...
                    >
                      <div className="absolute left-1/2 top-0 -mt-8 -translate-x-1/2">
                        <svg
                          className="absolute right-0 top-0 -mr-8 -mt-3 h-16 w-16 fill-current text-blue-500"
                          viewBox="0 0 64 64"
                          aria-hidden="true"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                      ...
                      <blockquote className="mb-4 text-xl font-medium">{item.quote}</blockquote>
                      <cite className="mb-1 block text-lg font-bold not-italic">{item.name}</cite>
              ...
              <div className="absolute inset-0 flex items-center justify-between">
                <button
                  type="button"
                  className="relative z-20 flex h-16 w-16 -translate-x-2 items-center justify-center rounded-full border border-gray-200 bg-white p-1 shadow-md hover:shadow-lg md:-translate-x-1/2"
                  onClick={() => {
