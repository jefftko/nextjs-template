        ...
        <div className="border-t border-gray-200 py-12 md:py-16">
          ...
          <div className="relative mx-auto grid max-w-sm items-start gap-6 md:max-w-2xl md:grid-cols-2 lg:max-w-none lg:grid-cols-4">
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">Apply</h4>
              <p className="text-center text-gray-600">
                Duis aute irure dolor in reprehenderitin volupta velit esse cillum sint occaecat
                cupidatat.
              </p>
            </div>
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">Screening</h4>
              <p className="text-center text-gray-600">
                Duis aute irure dolor in reprehenderitin volupta velit esse cillum sint occaecat
                cupidatat.
              </p>
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">Interview</h4>
              <p className="text-center text-gray-600">
                Duis aute irure dolor in reprehenderitin volupta velit esse cillum sint occaecat
                cupidatat.
              </p>
            ...
            <div className="relative flex flex-col items-center rounded bg-white p-6 shadow-xl">
              ...
              <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">Job Offer</h4>
              <p className="text-center text-gray-600">
                Duis aute irure dolor in reprehenderitin volupta velit esse cillum sint occaecat
                cupidatat.
              </p>
