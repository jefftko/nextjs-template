        ...
        <div className="pb-12 pt-32 md:pb-20 md:pt-40">
          ...
          <div className="mx-auto max-w-3xl pb-12 text-center md:pb-16">
            ...
            <p className="text-xl text-gray-600">
              We have transformed product development, making it faster, simpler... better! That's
              why in just three years we now help more developers build projects than anyone else.
            </p>
          </div>
