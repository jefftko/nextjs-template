          ...
          <div className="pb-12 pt-32 md:pb-20 md:pt-40">
            ...
            <div className="mx-auto max-w-3xl pb-12 text-center md:pb-16">
              ...
              <p className="text-xl text-gray-600" data-aos="zoom-y-out" data-aos-delay="150">
                Select a category to email the support team or contact us directly by using the form
                below.
              </p>
            </div>
            ...
            >
              {/* 1st item */}
              <div
                className="relative flex flex-col rounded bg-white p-6 shadow-xl"
                data-aos="zoom-y-out"
              ...
              >
                ...
                <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">Tech Support</h4>
              ...
              >
                ...
                <h4 className="mb-1 text-xl font-bold leading-snug tracking-tight">Live Chat</h4>
                <p className="text-gray-600">
                  Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </p>
              </div>
        ...
        <div className="mx-auto max-w-6xl px-4 sm:px-6">
          <div className="pb-12 pt-32 md:pb-20 md:pt-40">
            ...
            <form className="mx-auto max-w-xl">
              ...
              <div className="-mx-3 mb-4 flex flex-wrap">
                <div className="w-full px-3">
                  <label className="mb-1 block text-sm font-medium text-gray-800" htmlFor="subject">
              ...
              <div className="-mx-3 mb-4 flex flex-wrap">
                <div className="w-full px-3">
                  <label className="mb-1 block text-sm font-medium text-gray-800" htmlFor="country">
                    Country
                  </label>
              ...
              <div className="-mx-3 mb-4 flex flex-wrap">
                <div className="w-full px-3">
                  <label className="mb-1 block text-sm font-medium text-gray-800" htmlFor="message">
                    Message
                  </label>
                  <textarea
                    id="message"
              ...
              <div className="mt-4 text-sm text-gray-600">
                By clicking "send" you consent to allow Simple to store and process the personal
                information submitted above and agree to our{' '}
