    ...
    <div className="md:grow">
      <div className="text-lg text-gray-600">
        ...
        <p className="mb-8">
          ...
          <strong className="font-medium text-gray-900">adipiscing tristique risus</strong> nec
          feugiat auctor urna nunc id cursus metus aliquam eleifend, arcu dictum varius duis at
          consectetur lorem donec massa sapien, sed risus ultricies tristique nulla aliquet.{' '}
          <strong className="font-medium text-gray-900">Morbi tristique senectus</strong> et netus
        ...
        <p className="mb-8">
          Sit amet cursus sit amet dictum sit amet. Mattis pellentesque id nibh tortor id nulla
          aliquet porttitor lacus luctus accumsan, tortor posuere pellentesque habitant morbi
          tristique senectus et netus. Lacinia quis vel eros donec ac odio tempor duis ut diam quam
          nulla. Tellus orci ac auctor augue mauris augue.
        </p>
        ...
        <p className="mb-8">
          ...
          <strong className="font-medium text-gray-900">Pellentesque habitant morbi</strong>{' '}
          tristique senectus et netus, lacinia quis vel eros donec ac odio tempor. Duis ut diam quam
          nulla tellus orci ac auctor augue mauris augue.
        </p>
        ...
        <h3 id="quick" className="h3 mb-8 text-gray-900" style={{ scrollMarginTop: '100px' }}>
          Quick start
        </h3>
        <h4 className="h4 mb-4 text-gray-900">Customising settings</h4>
        <p className="mb-8">
          Orci ac auctor augue mauris augue neque gravida in sapien faucibus et molestie ac feugiat
          sed lectus vestibulum mattis senectus et{' '}
        ...
        <p className="mb-8">
          ...
          id cursus metus aliquam eleifend, arcu dictum varius duis at consectetur lorem donec massa
        ...
        <h3 id="folder" className="h3 mb-8 text-gray-900" style={{ scrollMarginTop: '100px' }}>
          Folder content
        </h3>
        <p className="mb-8">
          Aenean sed adipiscing diam donec adipiscing tristique risus nec feugiat auctor urna nunc
        ...
        <p>For more information on what to do next, we recommend the following articles:</p>
      </div>
      ...
      <div className="mt-8">
        ...
        >
          <div>
            <div className="text-normal mb-1 font-medium">Folder components</div>
